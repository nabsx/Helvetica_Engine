        ...
        <aside class="w-full border-b border-slate-200 bg-white lg:min-h-screen lg:w-72 lg:border-b-0 lg:border-r">
            ...
            <div class="px-5 py-6"><p class="px-3 text-[11px] font-bold uppercase tracking-[0.18em] text-slate-400">Workspace</p>
                <nav class="mt-3 space-y-1">
                    @foreach([
                        ['admin.dashboard', 'Dashboard'], ['admin.inventory.index', 'Inventory control'], ['admin.products.index', 'Produk & harga'], ['admin.categories.index', 'Kategori'], ['admin.expenses.index', 'Expenses'], ['admin.sales-report', 'Laporan'], ['admin.cancellations.index', 'Pembatalan'], ['admin.shifts.index', 'Cash monitoring'], ['admin.users.index', 'Staff'], ['pos.index', 'Buka POS'],
                    ] as [$route, $label])

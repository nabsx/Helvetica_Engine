...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('admin')->prefix('admin')->name('admin.')->group(function (): void {
        ...
        Route::post('/inventory/{product}/adjust', [AdminInventoryController::class, 'storeAdjustment'])->name('inventory.adjust.store');
        Route::get('/inventory/{product}/export', [AdminInventoryController::class, 'exportHistory'])->name('inventory.export');
